...
//traditional methods of style using js
document.getElementById("head").setAttribute("style","background-color:black;" "color:white;");
document.getElementById("head").style.backgroundColor = "black";
document.getElementById("head").style.backgroundColor = "white";

//let h1att = document.getElementById("head").setAttribute("class"."heading")
   let h1att = document.getElementById("head").className = "heading";
   document.getElementById("head").classList.add("com-head")
//    document.getElementById("head").classList.remove("heading")
